...
public class CustomIotaApi extends CustomIotaAPICore{
	 ...
	 private static final Logger log = LoggerFactory.getLogger(IotaAPI.class);
	    ...
	    public static class Builder extends CustomIotaAPICore.Builder<Builder> {
	        ...
	        public CustomIotaApi build() {
	            super.build();
	            return new CustomIotaApi(this);
	        }
	    }
